...
-- --REGULAR QUERY TO CREATE TABLES
--    SELECT CONCAT(serialno, sporder) AS unique_id,
--            pwgtp,
--            sch,
--            schl,
...
--    JOIN puma_names_2010
--        ON puma_names_2010.puma = pums_2017.puma
--    WHERE (puma_names_2010.puma BETWEEN '11601' AND '11616')
